public class ExpressionTree{
  ...
  public String toString(){
    String to_return = "";
    if(isOp()){
      return to_return + "(" + getLeft().toString() + " " +getOp() + " " + getRight().toString() + ")";
    }
  ...
  public String toStringPostfix(){
    String to_return = "";
    if(isOp()){
      return to_return + getLeft().toStringPostfix() + " " + getRight().toStringPostfix() + " " + getOp();
    }
    return to_return + getValue();
  }
  ...
  public String toStringPrefix(){
    String to_return = "";
    if(isOp()){
      return to_return + getOp() + " " + getLeft().toStringPrefix() + " " + getRight().toStringPrefix();
    }
    return to_return + getValue();
  }
